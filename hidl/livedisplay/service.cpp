...
#define LOG_TAG "samsung.livedisplay@2.0-service.samsung-qcom"
#else
#define LOG_TAG "vendor.samsung.livedisplay@2.0-service.samsung-qcom"
#endif
...
using vendor::samsung::livedisplay::V2_0::samsung::DisplayColorCalibration;
...
using vendor::samsung::livedisplay::V2_0::samsung::SunlightEnhancement;
