...
#define LOG_TAG "samsung.livedisplay@2.0-service.samsung-exynos"
#else
#define LOG_TAG "vendor.samsung.livedisplay@2.0-service.samsung-exynos"
#endif
...
using vendor::samsung::livedisplay::V2_0::samsung::AdaptiveBacklight;
using vendor::samsung::livedisplay::V2_0::samsung::DisplayColorCalibrationExynos;
using vendor::samsung::livedisplay::V2_0::samsung::DisplayModes;
using vendor::samsung::livedisplay::V2_0::samsung::ReadingEnhancement;
using vendor::samsung::livedisplay::V2_0::samsung::SunlightEnhancementExynos;
