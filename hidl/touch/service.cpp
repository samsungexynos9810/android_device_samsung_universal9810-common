...
#define LOG_TAG "vendor.samsung.touch@1.0-service.samsung"
...
using ::vendor::samsung::touch::V1_0::samsung::GloveMode;
using ::vendor::samsung::touch::V1_0::samsung::KeyDisabler;
using ::vendor::samsung::touch::V1_0::samsung::StylusMode;
using ::vendor::samsung::touch::V1_0::samsung::TouchscreenGesture;
